...
if submit_btn:
    ...
    if errors:
        ...
        st.success("✅ הנתונים נשמרו בהצלחה! (נשמרים לאורך זמן, כולל יומן וגיבויים)")
        st.info("טיפ: לצפייה/הורדה של הנתונים, הוסיפי לכתובת האתר ?admin=1 והיכנסי עם סיסמת המנהל.")
